# Flight tuning report — mr2-servo-1
...
| baseline.fullStick500.peakAoa | 7.582 deg | — | report |
| B12.fullStick500.peakIncidence | 7.582 deg | −∞ … 25 | ok |
| B12.fullStick500.limiterOpen | 0.130 fraction | −∞ … 0.35 | ok |
| B1.cobra.peakAoa | 91.008 deg | 90 … 120 | ok |
| B2.cobra.timeTo90 | 1.233 s | 0.7 … 1.2 | ⚠ out |
| B3.cobra.speedLoss | 83.165 arcade km/h | — | report |
| B4.cobra.headingChange | 83.584 deg | −∞ … 20 | ⚠ out |
| B5.kulbit.time360 | 3.733 s | 3 … 4.5 | ok |
| B15.reversal.headingChange | 131.447 deg at 10 s / stop | — | report |
| B15.reversal.altitudeLoss | 382.945 m | — | report |
...
| B14.psmIntent.timeTo70 | 0.858 s | −∞ … 1.2 | ok |
| psmIntent.timeToLimiter90 | 0.217 s | — | report |
| psmIntent.peakIncidence | 107.811 deg | — | report |
...
| baseline.fullStick500.peakAoa | 7.685 deg | — | report |
| B12.fullStick500.peakIncidence | 7.685 deg | −∞ … 25 | ok |
| B12.fullStick500.limiterOpen | 0.130 fraction | −∞ … 0.35 | ok |
| B1.cobra.peakAoa | 90.663 deg | 90 … 120 | ok |
| B2.cobra.timeTo90 | 1.267 s | 0.7 … 1.2 | ⚠ out |
| B3.cobra.speedLoss | 91.502 arcade km/h | — | report |
| B4.cobra.headingChange | 90.089 deg | −∞ … 20 | ⚠ out |
| B5.kulbit.time360 | 3.867 s | 3 … 4.5 | ok |
| B15.reversal.headingChange | 139.377 deg at 10 s / stop | — | report |
| B15.reversal.altitudeLoss | 294.164 m | — | report |
...
| B14.psmIntent.timeTo70 | 0.858 s | −∞ … 1.2 | ok |
| psmIntent.timeToLimiter90 | 0.217 s | — | report |
| psmIntent.peakIncidence | 101.594 deg | — | report |
| psmIntent.peakLimiter | 1.000 fraction | — | report |
