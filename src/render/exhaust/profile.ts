...
export const exhaustProfiles = {
  f22: { lipX: -7.3654, height: -1.0373, spacing: .6517, centerZ: -.00665, width: .445, radiusY: .205, inset: .82, round: 0, chamberRadius: .40, burnerViolet: .22, length: 5.8, turbulence: .15 },
